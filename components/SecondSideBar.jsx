...
// Link
const SecondSideBar = ({ SideBarSecondLinks, close }) => {
    ...
    const handleLogout = () => {
        ...
        // Close the sidebar after a delay (e.g., 500 milliseconds)
    ...
    return (
        <div className='flex flex-col gap-y-4 w-full h-full'>
            ...
            <button className={`w-[100%] hover:bg-[#E0F3F3] rounded-[10px] bg-[#F8F8F863] p-3 text-white capitalize`} onClick={handleLogout}>
                <div className='flex items-center text-base  w-[100%]  gap-x-4 capitalize'>
