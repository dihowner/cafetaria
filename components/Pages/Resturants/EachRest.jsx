...
const EachRest = ({ restuarantsDetails }) => {
    return (
        <div className='w-full flex justify-center items-center flex-col'>
            <div className="w-full eachrest flex justify-center items-center" style={{
                ...
                <div className="width flex justify-between items-center border gap-x-4 ">
                    <div className="w-[70%] shadow-md bg-[white] rounded-md flex flex-col p-4 gap-y-4 ">
                        ...
                        <div className='flex gap-x-2 items-center'>
                            <span className='text-[#5b7555]'>{restuarantsDetails.ratings}</span>
                    ...
                    <div className="w-[30%] bg-[white] shadow-md rounded-md flex flex-col p-4 gap-y-6">
                        <div className="flex justify-between items-center">
                            ...
                            />
                            {/* <div className="bg-[#218B07] flex justify-center items-center py-2 text-[white] rounded-[20px] px-4 gap-x-4">
