...
const TopSideBar = () => {
    return (
        <div className='width grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 gap-x-8 gap-y-4  border '>
            <div className=" py-6 px-4 flex justify-center items-center flex-col gap-y-4 rounded-[16px]">
