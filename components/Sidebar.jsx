...
const Sidebar = ({ SideBarFirstLinks,
    ...
    return (
        <div className={`${isSidebarOpen
            ? 'hidden  w-[220px] lg:block lg:w-[220px] bg-[#218B07] fixed overflow-auto shadow-[rgb(113 122 131 / 11%) 0px 7px 30px h-[100vh] 0px;] transition-[all] ease duration-[.3s] z-[10] md:block'
