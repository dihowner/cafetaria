                ...
                <Dialog as='div' className='relative z-10 ' initialFocus={cancelButtonRef} onClose={handleClose}>
                    ...
                    <div className='fixed inset-0 z-10 overflow-y-auto mt-[90px]'>
                        <div className='flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0'>
                            ...
                            >
                                <Dialog.Panel className={`relative transform overflow-y-scroll rounded-lg bg-[#FAFAFA] text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg p-4 flex flex-col gap-y-2 h-[${height}] w-[100%]`}>
                                    {children}
                                </Dialog.Panel>
                            </Transition.Child>
                        </div>
